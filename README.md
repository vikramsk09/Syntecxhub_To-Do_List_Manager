...
A simple command-line To-Do List Manager built using Python that allows users to add, view, and delete tasks through a menu-driven interface.
...
3) Delete tasks by selecting task number
